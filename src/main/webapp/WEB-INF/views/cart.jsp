		...
		<div class="container">
			...
			<div class="table-responsive cart_info">
				<table class="table table-condensed">
					...
					<tbody>
					<c:choose>
					<c:when test="${ empty cart}"> <!-- mo item in cart-->
					<tr><td colspan="5">
					...
					<c:forEach var="c" items="${cart}">
						...
						<tr>
							<td class="cart_product">
								<a href="productDetails?productId=${c.product.productId} "><img src="getImg?id=productId" alt="" style="height: 150px; width: 150px"></a>
							</td>
