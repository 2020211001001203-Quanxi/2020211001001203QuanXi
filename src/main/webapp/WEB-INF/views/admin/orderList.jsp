			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<%
							com.QuanXi.model.Order o=(com.QuanXi.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.QuanXi.dao.UserDao userDao=new com.QuanXi.dao.UserDao();
						...
						<%
							...
							String paymentType=com.QuanXi.model.Payment.findByPaymentId(con,n);
							 %>
